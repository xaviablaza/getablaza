...
> Source-copy draft imported from [https://templeton.host/visualizations/convexity/](https://templeton.host/visualizations/convexity/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
