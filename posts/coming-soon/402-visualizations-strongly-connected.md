...
> Source-copy draft imported from [https://templeton.host/visualizations/strongly-connected/](https://templeton.host/visualizations/strongly-connected/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
