...
> Source-copy draft imported from [https://templeton.host/visualizations/taylor-series/](https://templeton.host/visualizations/taylor-series/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
