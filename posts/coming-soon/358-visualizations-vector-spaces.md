...
> Source-copy draft imported from [https://templeton.host/visualizations/vector-spaces/](https://templeton.host/visualizations/vector-spaces/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
