...
> Source-copy draft imported from [https://templeton.host/visualizations/gradients/](https://templeton.host/visualizations/gradients/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
