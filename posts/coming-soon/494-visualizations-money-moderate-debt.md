...
> Source-copy draft imported from [https://templeton.host/visualizations/money-moderate-debt/](https://templeton.host/visualizations/money-moderate-debt/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
