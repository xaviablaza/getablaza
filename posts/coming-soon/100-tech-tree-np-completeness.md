...
> Source-copy draft imported from [https://templeton.host/tech-tree/np-completeness/](https://templeton.host/tech-tree/np-completeness/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
