...
description: When to sell, refinance, or hold rental property. The equity trap - your home equity earns 0% return. Cash-out refi to redeploy idle capital.
date: '2026-07-01'
scheduled: '2027-04-04'
tags:
- p-and-l-engineering
- coming-soon
- money
...
source_format: html
inspiration_url: https://templeton.host/money/return-on-equity/
inspiration_category: money
---

> Source-copy draft imported from [https://templeton.host/money/return-on-equity/](https://templeton.host/money/return-on-equity/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
...
Return on equity in rental property is the individual-scale version of operating returns - your property's NOI relative to trapped equity is the same concept as a business's operating outcome relative to invested capital](/business/stock-returns/)[Financial RatiosBusiness

ROE is a core DuPont decomposition ratio; the personal finance node teaches the same capital efficiency logic (idle equity earns 0%) that drives business ROE analysis](/business/financial-ratios/)[Value LeakageBusiness

Home equity earning 0% is the canonical personal-finance example of value leaking at an unnamed edge - capital trapped in an asset where nobody notices it is idle until someone names the equity trap.](/business/value-leakage/)[Enterprise ValueBusiness

The equity trap (home equity earning 0% return) is a concrete individual-scale mispriced edge. Cash-out refi to redeploy idle capital is exactly the same logic as enterprise-level identification and exploitation of mispriced capital allocation.](/business/enterprise-value/)[private equityBusiness

PE value creation is ROE maximization at portfolio scale. The personal finance node teaches the same concept through rental property - idle equity earning 0%, cash-out refi to redeploy. PE does this across entire companies: lever up, optimize operations, harvest equity growth.](/business/private-equity/)[home equityBusiness

Directly addresses the equity trap: $150K in home equity earns 0% return sitting idle, and when to extract via cash-out refi to redeploy](/business/home-equity/)[PE Portfolio OperationsBusiness

PE value creation doctrine treats idle equity in portfolio companies the same way - cash-out refi, dividend recaps, and working capital optimization all redeploy idle capital to higher-return uses](/business/pe-portfolio-operations/)[CFABusiness

DuPont ROE decomposition (margin x turnover x leverage) is a core CFA equity analysis framework; personal finance applies the same concept to rental property hold/sell decisions](/business/cfa/)[Multi-Brand PortfolioBusiness

Turnaround vs divest decisions for underperforming brands use the same hold/sell/reinvest framework as idle equity in real estate](/business/multi-brand-portfolio/)[OperatorBusiness

PE turnarounds are fundamentally ROE plays - buying underperforming equity, improving returns on it, and deciding when to hold vs exit. Same concept as redeploying idle home equity, but with control premium.](/business/operator/)[PE operatorsBusiness

ROE is PE's defining metric; the personal finance insight that idle home equity earns 0% return is exactly why PE does dividend recaps, cash-out refinancing, and leveraged recapitalizations to redeploy idle capital](/business/pe-operators/)[Portfolio AlphaBusiness

The operator half of Portfolio Alpha. Individual scale: home equity earns 0%, so redeploy via cash-out refi. Portfolio scale: idle equity in underperforming businesses gets redeployed through operational improvement - the mechanism by which the Operator generates alpha on the Allocator's deployed capital.](/business/portfolio-alpha/)
...
## The Problem - What Goes Wrong When Equity Sits Idle
...
ROE=Annual Cash Flow After Debt+Principal Paydown+AppreciationEquityROE = \dfrac{Annual\ Cash\ Flow\ After\ Debt + Principal\ Paydown + Appreciation}{Equity}ROE=EquityAnnual Cash Flow After Debt+Principal Paydown+Appreciation​

Where:

- •Annual Cash Flow After Debt equals NOI minus annual debt service. Example: $30,000 NOI - $18,000 debt service = $12,000.
- •Principal Paydown equals scheduled loan principal reduction, for example $3,000 per year.
- •Appreciation equals change in market value, for example 3% of $400,000 equals $12,000 per year nominal.
- •Equity equals market value minus outstanding debt. Example: $400,000 - $220,000 = $180,000.
...
Net Benefit=Redeployed Return−Incremental Debt Cost−Fees spreadNet\ Benefit = Redeployed\ Return - Incremental\ Debt\ Cost - Fees\ spreadNet Benefit=Redeployed Return−Incremental Debt Cost−Fees spread.

IF redeployment return exceeds incremental borrowing cost plus a buffer of 1-3% AND contingency reserves remain at 3-6 months of expenses, THEN refinancing to redeploy can increase portfolio ROE BECAUSE the previously idle capital now compounds at a higher rate. If those conditions fail, refinancing lowers expected risk-adjusted returns.

## The Decision Framework - IF/THEN/BECAUSE Checklist
...
- •The model omits tax-basis effects for capital gains and any step-up rules, which can change the effective cost of selling.
- •It assumes access to refinancing at quoted rates; borrowers with credit issues may face rates 2-4% higher.
- •It ignores behavioral frictions and the value of optionality - for example the utility of debt-free ownership in high-stress cases.
- •It treats redeployment returns as probabilistic point ranges; execution risk can reduce realized returns by 1-5% or more.
...
### Cash-Out Refi to Buy a Second Rental
...
1. Compute initial equity: $400,000 - $220,000 = $180,000.
2. Estimate new loan amount. To extract $80,000 after paying 3% fees on new loan find new loan L such that cash-out = L - 220,000 - 0.03L. Solve: cash-out = 0.97L - 220,000 = 80,000 so 0.97L = 300,000 so L ≈ $309,278. Round to $309,300.
3. New equity after refi: $400,000 - $309,300 = $90,700.
4. Calculate incremental annual debt cost. Old annual debt service approximated from 4.0% interest only on $220,000 is $8,800. New interest-only cost at 4.75% on $309,300 is $14,707. Incremental cost ≈ $5,907 per year. (If amortizing, include principal paydown differences separately.)
5. Estimate redeployment return: $80,000 × 8% = $6,400 per year after taxes.
6. Net incremental annual benefit: $6,400 - $5,907 = $493. Include lost principal paydown if amortizing; if amortization reduces incremental cost by $1,500 per year then net benefit rises to ≈ $1,993.
7. Compute change in ROE. Before refi assume numerator $12,000 cash flow after debt + $3,000 principal paydown + $12,000 appreciation = $27,000. ROE before = $27,000 / $180,000 = 15%. After refi numerator approximates $4,093 net cash flow after higher debt + similar principal paydown and appreciation numbers adjusted for new debt, yielding ROE roughly $20,000 / $90,700 ≈ 22% depending on amortization assumptions.
...
### Holding Versus Selling a Home to Fund Expenses
...
1. Selling option: Net proceeds = $500,000 - $350,000 - 7%\*$500,000 - $15,000 = $500,000 - $350,000 - $35,000 - $15,000 = $100,000. This meets the need but removes all home equity.
2. HELOC option: Borrow $100,000 at 7.5% interest. Annual interest cost ≈ $7,500. No immediate fees. No change in mortgage terms. Liquidity preserved and home ownership unchanged.
3. Cash-out refi option: New loan size required to free $100,000 after 3% fees equals L where 0.97L - 350,000 = 100,000 so L ≈ $467,010. New interest at 4.5% on $467,010 equals $21,015 annual. Old interest on $350,000 at 3.5% equals $12,250. Incremental cost ≈ $8,765 annually.
4. Compare options by annual cost and non-financial impacts. Selling costs include loss of appreciation and increased housing cost if renting elsewhere. HELOC costs most annually but avoids refinancing fees and preserves current mortgage rate.
5. Compute break-even redeployment requirement if using cash-out refi proceeds for investment: redeployment must exceed incremental cost of $8,765 plus desired buffer of 2% on $100,000 equals $10,765 per year or about 10.8% return.
...
### Using Home Equity to Pay High-Interest Debt
