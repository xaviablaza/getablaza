...
> Source-copy draft imported from [https://templeton.host/visualizations/orthogonality/](https://templeton.host/visualizations/orthogonality/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
