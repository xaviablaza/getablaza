...
> Source-copy draft imported from [https://templeton.host/visualizations/automatic-differentiation/](https://templeton.host/visualizations/automatic-differentiation/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
