...
> Source-copy draft imported from [https://templeton.host/tech-tree/rate-distortion/](https://templeton.host/tech-tree/rate-distortion/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
