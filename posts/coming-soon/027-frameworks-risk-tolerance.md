...
> Source-copy draft imported from [https://templeton.host/frameworks/risk-tolerance/](https://templeton.host/frameworks/risk-tolerance/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
