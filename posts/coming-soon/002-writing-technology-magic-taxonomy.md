...
source_frontmatter:
  ...
  status: published
  position: Scientist, Allocator
  position_note: I traced this protocol across ~700 years of technology transitions, from double-entry bookkeeping to the internet, and use it to reason about who wins
  revision: 9
  draft_id: 193992335
  staged_at: 2026-06-08 17:39
...
![Three kinds of magic: physics, representation, and agency - LLMs are the strongest agency magic](/images/posts/technology-magic-taxonomy.svg)
...
| Era | Technology | Rule Broken |
|-----|-----------|-------------|
| ~1440 | Printing press | Scalable text without scribes - authority becomes reproducible |
| ~1608 | Telescope | The heavens become inspectable, not just received |
| ~1676 | Microscope | Invisible life exists below perception threshold |
| ~1780 | Steam engine | Force without muscle - matter has agency |
| 1844 | Telegraph | Information outruns bodies |
| 1839-1860s | Photography | Reality writes itself - no human hand required |
| 1895 | Radio | A signal arrives with no wire at all |
| 1895 | X-ray | Sight penetrates opaque matter |
| 1927 | Television | Remote presence - be somewhere you're not |
| 1945 | Atomic bomb | Energy density reaches godlike scale |
| 1969 | Moon landing | The sky is navigable, not just observable |
| 1991 | World Wide Web | Global mind-mesh - collective cognition at distance |
| 2007 | Smartphone | Omniscient oracle in your pocket (GPS from 2008) |
| 2022 | LLMs | Fluent language without a mind behind it |
| 2024+ | Synthetic media | Reality itself becomes editable |
...
*Go deeper: [The Eighth Ledger: When Intellectual Labor Becomes a Capital Asset](/writing/capitalizing-intellectual-labor/) backtests the protocol against five more transitions - limited liability, the assembly line, containerization, the internet, and double-entry bookkeeping - then applies the full protocol to LLMs with specific numbers, cost tables, role migration maps, and winners/losers analysis. [Knowledge Capital](/frameworks/knowledge-capital/) formalizes the framework: the model depreciates, the data appreciates.*
