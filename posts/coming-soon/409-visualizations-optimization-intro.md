...
> Source-copy draft imported from [https://templeton.host/visualizations/optimization-intro/](https://templeton.host/visualizations/optimization-intro/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
