...
> Source-copy draft imported from [https://templeton.host/visualizations/second-order-methods/](https://templeton.host/visualizations/second-order-methods/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
