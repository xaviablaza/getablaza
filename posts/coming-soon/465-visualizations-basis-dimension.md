...
> Source-copy draft imported from [https://templeton.host/visualizations/basis-dimension/](https://templeton.host/visualizations/basis-dimension/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
