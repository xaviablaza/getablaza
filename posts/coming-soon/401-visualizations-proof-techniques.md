...
> Source-copy draft imported from [https://templeton.host/visualizations/proof-techniques/](https://templeton.host/visualizations/proof-techniques/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
