...
description: Protecting your most valuable asset - your income stream. Short-term vs long-term. Own-occupation vs any-occupation. Employer vs private.
date: '2026-07-01'
...
source_format: html
inspiration_url: https://templeton.host/money/disability-insurance/
inspiration_category: money
---

> Source-copy draft imported from [https://templeton.host/money/disability-insurance/](https://templeton.host/money/disability-insurance/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
...
[Insurance Basicslvl 2](/money/insurance-basics/)
...
Disability insurance is the direct financial instrument for hedging income instability - it replaces the income stream when you physically cannot](/business/income-stability/)
...
### Own-Occupation for a Specialist Physician

Dr. Lin earns $350,000 per year ($29,167 monthly). Employer LTD offers any-occupation coverage up to 60% to age 65. Dr. Lin estimates a private own-occupation policy increases premium by 40% versus any-occupation. She wants to avoid career-ending income loss.

1. Calculate employer LTD gross benefit: 60% of $29,167 = $17,500 per month. If taxable at 30%, net = $17,500 \* 0.70 = $12,250.
2. Target replacement for Dr. Lin is 80% net of gross: 80% of $29,167 = $23,333 per month.
3. Shortfall S = $23,333 - $12,250 = $11,083 per month that needs private coverage or savings.
4. Estimate cost: if any-occupation private LTD for this gap costs 1.5% of salary annually, that would be 0.015 \* $350,000 = $5,250 per year. Own-occupation premium would be about 40% more, or $7,350 per year.
5. Compare trade-offs: paying an extra $2,100 annually buys own-occupation protection that is likely to pay when Dr. Lin cannot perform surgical duties even if she could perform other lower-paid jobs.
...
Easy: Sam earns $54,000 per year ($4,500 monthly). Employer STD pays 60% for 12 weeks taxable. Sam needs 75% replacement for essential expenses. If Sam's marginal tax rate is 22%, calculate the monthly shortfall after STD and the private monthly benefit needed to reach 75% replacement.

**Hint:** Compute employer STD net after tax, then target net replacement equals 75% of gross monthly income.

Show solution

Employer STD gross = 60%  *$4,500 = $2,700. After-tax STD = $2,700*  (1 - 0.22) = $2,106. Target net replacement = 75% \* $4,500 = $3,375. Shortfall = $3,375 - $2,106 = $1,269. Sam needs a private tax-free monthly benefit of $1,269 to reach 75% replacement.
...
Gross monthly income = $95,000/12 = $7,916. Employer LTD gross = 60%  *$7,916 = $4,749. After-tax employer LTD = $4,749*  (1 - 0.24) = $3,609. Target 80% net = 0.80  *$7,916 = $6,333. Shortfall = $6,333 - $3,609 = $2,724. A 20% gap of gross income equals 0.20*  $7,916 = $1,583 per month. If private LTD pays tax-free, it would need to provide $2,724 to fully close the net shortfall, which is larger than 20% of gross due to taxation. Annual cost of a 20% gap policy if priced at 1.5% of salary equals 0.015 \* $95,000 = $1,425, or $119 per month. That $119 monthly premium yields a tax-free benefit roughly equal to the policy's monthly benefit; if the policy indeed pays $1,583 monthly, then Maria would exceed the needed $2,724 target only if policy amount equals the net shortfall. Conclusion: a 20% gross gap policy likely underfills the post-tax shortfall; Maria would need private coverage larger than 20% of gross or to increase savings.

hard

Hard: Tyler is a 45-year-old freelance graphic designer with three-year average net income of $80,000 and current year income of $40,000. He wants LTD coverage that uses an averaged income base. A policy offers averaging over 2-3 years but charges 25% higher premium for averaging. Base premium for single-year underwriting would be 1.6% of current year income. Evaluate the annual premium and the effective monthly benefit in both scenarios, and decide IF averaging reduces underwriting risk enough to justify the extra cost. Assume desired benefit equals 60% of income.
...
Current-year income = $40,000. 3-year average = $80,000. Desired 60% of income monthly benefit with current-year underwriting: monthly gross income = $40,000/12 = $3,333. Benefit = 0.60  *$3,333 = $2,000 per month. Annual premium at 1.6% of current income = 0.016*  $40,000 = $640. With averaging, premium increases by 25% = $640  *1.25 = $800 annually. But policy uses $80,000 income to set benefits: monthly gross = $80,000/12 = $6,667. Benefit = 0.60*  $6,667 = $4,000 per month. Effective cost per month of benefit: current-year policy cost per month = $640/12 = $53.33 for $2,000 benefit, or $0.0267 per benefit dollar. Averaged policy cost per month = $800/12 = $66.67 for $4,000 benefit, or $0.0167 per benefit dollar. IF Tyler expects income to revert near the 3-year average AND needs benefit tied to historical earnings, THEN paying 25% more in premium may be cost-effective BECAUSE the averaged policy delivers twice the monthly benefit and a lower cost per benefit dollar, stabilizing coverage despite recent income dips. If Tyler expects long-term income decline, THEN single-year underwriting may be preferable.
