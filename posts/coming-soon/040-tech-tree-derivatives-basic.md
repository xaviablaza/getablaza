...
> Source-copy draft imported from [https://templeton.host/tech-tree/derivatives-basic/](https://templeton.host/tech-tree/derivatives-basic/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
