...
> Source-copy draft imported from [https://templeton.host/visualizations/relations/](https://templeton.host/visualizations/relations/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
