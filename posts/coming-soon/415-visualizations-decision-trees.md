...
> Source-copy draft imported from [https://templeton.host/visualizations/decision-trees/](https://templeton.host/visualizations/decision-trees/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
