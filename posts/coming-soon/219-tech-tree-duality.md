...
> Source-copy draft imported from [https://templeton.host/tech-tree/duality/](https://templeton.host/tech-tree/duality/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
