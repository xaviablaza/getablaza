...
description: 'AI automation is capital allocation. Five tools for the decision sequence: diagnose, calibrate, invest, value, screen.'
date: '2026-07-01'
...
> Source-copy draft imported from [https://templeton.host/tools/](https://templeton.host/tools/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
...
1. [1
   ...
   The Verification Quadrant →T = time\_to\_do / time\_to\_check
...
2. [2
   ...
   The Dollarized Confusion Matrix →θ\* = C\_FP / (C\_FP + C\_FN)
...
4. [4
   ...
   Automation NPV →S = (value × P(success)) / build\_cost
...
5. [5
   ...
   TaskVector →score = avg(d\_1..d\_9), landmine = any(d\_i == 1)
...
See also: [Frameworks](/frameworks/) · [Lexicon](/lexicon/)
