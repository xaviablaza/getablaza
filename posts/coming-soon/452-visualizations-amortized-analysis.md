...
> Source-copy draft imported from [https://templeton.host/visualizations/amortized-analysis/](https://templeton.host/visualizations/amortized-analysis/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
