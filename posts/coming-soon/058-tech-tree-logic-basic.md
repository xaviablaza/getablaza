...
> Source-copy draft imported from [https://templeton.host/tech-tree/logic-basic/](https://templeton.host/tech-tree/logic-basic/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
