...
> Source-copy draft imported from [https://templeton.host/visualizations/causal-inference/](https://templeton.host/visualizations/causal-inference/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
