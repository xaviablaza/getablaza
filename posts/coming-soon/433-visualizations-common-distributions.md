...
> Source-copy draft imported from [https://templeton.host/visualizations/common-distributions/](https://templeton.host/visualizations/common-distributions/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
