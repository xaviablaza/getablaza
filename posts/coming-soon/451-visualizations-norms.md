...
> Source-copy draft imported from [https://templeton.host/visualizations/norms/](https://templeton.host/visualizations/norms/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
