...
> Source-copy draft imported from [https://templeton.host/visualizations/graph-coloring/](https://templeton.host/visualizations/graph-coloring/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
