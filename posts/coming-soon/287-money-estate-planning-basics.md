...
description: Wills, revocable trusts, power of attorney, healthcare directive, beneficiary designations. What happens to your money and decisions when you can't make them.
date: '2026-07-01'
...
source_format: html
inspiration_url: https://templeton.host/money/estate-planning-basics/
inspiration_category: money
---

> Source-copy draft imported from [https://templeton.host/money/estate-planning-basics/](https://templeton.host/money/estate-planning-basics/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
...
[Life Insurancelvl 3](/money/life-insurance/)[Capital Gainslvl 3](/money/capital-gains-planning/)

## Unlocks (1)

[Charitable Giving Strategylvl 5](/money/charitable-giving-strategy/)

## Referenced by Business (1)

Where this personal-finance concept shows up inside the operating-finance graph.

[Financial PlannerBusiness

Estate planning is the personal finance domain where professional financial planning help is most clearly necessary - legal documents, trust structures, and beneficiary coordination exceed typical DIY competence and illustrate why the financial planner role exists.](/business/financial-planner/)
...
## The Problem - What Goes Wrong Without a Plan
...
1. Compute gross probate assets: home $350,000 + checking $20,000 + brokerage $50,000 = $420,000.
2. Estimate probate costs at 4%: $420,000 \* 0.04 = $16,800.
3. Compare to revocable trust setup cost $2,000 and annual admin $300. First-year cost = $2,300.
4. IF Alice values speed/privacy and wants to save expected $16,800, THEN spending $2,300 may be favorable BECAUSE net benefit ~ $14,500 in year-one savings and faster transfer.
5. If Alice prefers low up-front cost and minimal maintenance, she could instead add beneficiary designations to brokerage and transfer the home into joint tenancy with rights of survivorship, which may reduce probate assets but has ownership and tax trade-offs.
...
### Medium Estate: Step-Up and Beneficiary Coordination
...
1. Compute gross estate for probate purposes only for nonbeneficiary assets. If 401(k) and life insurance have beneficiaries, they bypass probate. Probate assets = brokerage $600,000 + house equity if solely titled - assume none here = $600,000.
2. Estimate step-up benefit: unrealized gain = $600,000 - $200,000 = $400,000. At death, heirs receive stepped-up basis eliminating capital gains tax on that $400,000 under typical rules.
3. If probate costs are 4% on $600,000 = $24,000, compare against revocable trust cost $2,500 and annual $400. First-year net benefit ~ $21,100 from probate avoidance.
4. Account for mortgage debt: $200,000 reduces net estate available to heirs regardless of probate.
5. IF Bob funds a trust with the brokerage account AND keeps 401(k) beneficiary to spouse, THEN probate costs on $600,000 may be avoided BECAUSE the trust-owned assets transfer per the trust terms without court involvement.
...
1. Calculate tentative taxable estate above exemption. If exemption assumed $13,000,000, taxable amount = $18,000,000 - $13,000,000 = $5,000,000.
2. Estimate federal estate tax rough rate 40% on taxable amount: $5,000,000 \* 0.40 = $2,000,000 potential tax liability.
3. IF Carol uses irrevocable life insurance trust or lifetime gifting to reduce taxable estate by $2,000,000, THEN she may reduce estate tax and preserve that amount for heirs BECAUSE assets transferred out of the taxable estate are excluded from estate tax.
4. Factor in costs: legal and valuation fees for advanced planning often $10,000 to $50,000 depending on complexity, plus possible lost investment control.
