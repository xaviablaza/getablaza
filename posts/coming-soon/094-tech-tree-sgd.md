...
> Source-copy draft imported from [https://templeton.host/tech-tree/sgd/](https://templeton.host/tech-tree/sgd/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
