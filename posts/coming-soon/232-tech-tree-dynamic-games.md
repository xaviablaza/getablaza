...
> Source-copy draft imported from [https://templeton.host/tech-tree/dynamic-games/](https://templeton.host/tech-tree/dynamic-games/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
