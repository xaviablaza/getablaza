...
> Source-copy draft imported from [https://templeton.host/visualizations/duality/](https://templeton.host/visualizations/duality/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
