...
> Source-copy draft imported from [https://templeton.host/visualizations/svm/](https://templeton.host/visualizations/svm/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
