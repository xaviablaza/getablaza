---
title: Bank Accounts
description: Checking, high-yield savings, CDs, money market. FDIC insurance. Where to park cash and why.
date: '2026-07-01'
...
source_format: html
inspiration_url: https://templeton.host/money/bank-account-structure/
inspiration_category: money
---

> Source-copy draft imported from [https://templeton.host/money/bank-account-structure/](https://templeton.host/money/bank-account-structure/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
...
[Emergency Bufferlvl 1](/money/emergency-buffer/)
...
Checking, HYSA, CDs, and money market accounts are the specific instruments valued at face value; understanding where cash lives clarifies which assets use this simplest valuation method](/business/face-value/)[Low-Yield SavingsBusiness

Directly covers the hierarchy of account types (checking, HYSA, CDs, money market) that explains where low-yield savings sits and what better alternatives exist for parking cash](/business/low-yield-savings/)[Current AssetsBusiness

Bank accounts (checking, savings, CDs, money market) are the personal-scale version of current assets - liquid holdings convertible to cash quickly, just as business current assets (cash, receivables, inventory) are resources expected to convert within one year](/business/current-assets/)[liquid assetsBusiness

Checking, HYSA, CDs, and money market accounts are the individual-scale equivalent of liquid assets recorded at face value - same instruments, same near-zero valuation uncertainty](/business/liquid-assets/)
...
1. Calculate target range: 3 months = $2,500  *3 = $7,500; 6 months = $2,500*  6 = $15,000.
2. Decide buffer: $12,000 falls inside the 3-6 month range, so it meets the stated goal numerically.
3. Estimate annual interest using simple annual compounding: Interest = $12,000 \* 0.04 = $480 before taxes.
4. Compare liquidity: High-yield savings allows same-day transfers in most banks, matching the emergency access requirement.
5. Check FDIC: $12,000 is below the $250,000 FDIC insurance limit, so the principal is fully insured at a single bank.
...
### CD Ladder for a Planned Purchase
...
1. Option A - keep all in high-yield savings at 3.8%: Annual interest approx $50,000 \* 0.038 = $1,900. For 1.5 years with monthly compounding approximate A = P(1+0.038/12)^{18} => A ~ $52,908, gain ~ $2,908.
2. Option B - ladder 6 and 12-month CDs: place $25,000 in 6-month CD at 3.0% and $25,000 in 12-month CD at 3.5%. 6-month yield ~ $25,000*(1+0.03/2)-$25,000 = ~$376. 12-month yield ~ $25,000*0.035 = $875. Total interest ~ $1,251 over 12 months; second 6 months needs reinvestment at prevailing rates which could be 3.0-4.0%.
3. Compare: Savings option yields about $2,908 over 18 months versus ladder initial yields of about $1,251 plus unknown reinvestment for remaining 6 months. If rates rise, ladder can be reinvested at higher rates; if rates fall, the savings account may outperform.
4. Decision driver: since the time horizon is 18 months and liquidity is needed at that point, high-yield savings at 3.8% likely produces a higher guaranteed nominal amount unless short CD rates exceed 4.0% on average during the period.
...
### Keeping Deposits Below FDIC Thresholds

Single depositor has $600,000 cash. Goal: keep funds insured under FDIC limits of $250,000 per bank per ownership category.

1. Identify FDIC limit: $250,000 per depositor per insured bank.
2. Compute number of banks needed: ceil($600,000 / $250,000) = ceil(2.4) = 3 banks to keep all funds fully insured.
3. Split funds evenly across three insured banks: $600,000 / 3 = $200,000 at Bank A, $200,000 at Bank B, $200,000 at Bank C.
4. Verify insurance: Each $200,000 balance is below $250,000, so each portion is FDIC insured in the single-owner category.
5. Alternative: Use multiple ownership categories at the same institution, such as a joint account with spouse which can add $250,000 per co-owner, but this requires specific ownership titling and verification.
...
**Hint:** Use A=P(1+rn)ntA=P(1+\frac{r}{n})^{nt}A=P(1+nr​)nt with n=12n=12n=12, r=0.03r=0.03r=0.03, t=1t=1t=1.
