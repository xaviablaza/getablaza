...
> Source-copy draft imported from [https://templeton.host/visualizations/clustering/](https://templeton.host/visualizations/clustering/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
