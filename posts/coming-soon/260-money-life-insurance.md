...
description: Term vs whole life. You need it when someone depends on your income. 10-12x annual income in term coverage. Whole life is almost never the answer.
date: '2026-07-01'
scheduled: '2027-03-17'
tags:
- p-and-l-engineering
- coming-soon
- money
...
source_format: html
inspiration_url: https://templeton.host/money/life-insurance/
inspiration_category: money
---

> Source-copy draft imported from [https://templeton.host/money/life-insurance/](https://templeton.host/money/life-insurance/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
...
Term vs whole life. You need it when someone depends on your income. 10-12x annual income in term coverage. Whole life is almost never the answer.
...
[Estate Planninglvl 4](/money/estate-planning-basics/)
...
Life insurance transfers the risk of income loss at death by paying a **death benefit**; understanding term versus whole life lets a household pick coverage that meets dependency needs at the lowest long-run cost.
...
1. Calculate income replacement: $100,000 \times 12 = $1,200,000.
2. Add mortgage payoff: $1,200,000 + $300,000 = $1,500,000 total target.
3. Account for existing liquid savings: $1,500,000 - $20,000 = $1,480,000 net need.
4. Round to convenient policy size: $1,500,000 term policy covers income and mortgage comfortably.
...
1. Compute 20-year term total premiums: $50/month \times 12 \times 20 = $12,000.
2. Compute whole life total premiums: $1,200/month \times 12 \times 20 = $288,000.
3. Compute invested difference per month: $1,200 - $50 = $1,150. Invest $1,150 monthly at 5% for 20 years. Future value formula FV=P×(1+r)n−1rFV = P \times \frac{(1+r)^{n}-1}{r}FV=P×r(1+r)n−1​. With monthly r=0.05/12 and n=240, FV \approx $1,150 \times (\frac{(1+0.0041667)^{240}-1}{0.0041667}) \approx $1,150 \times 452.9 \approx $520,835.
4. Compute whole life cash value at 3% with contributions of $1,200/month: monthly r=0.03/12, FV \approx $1,200 \times (\frac{(1+0.0025)^{240}-1}{0.0025}) \approx $1,200 \times 364.0 \approx $436,800.
5. Compare: Term + invested difference yields approximately $520,835 in investments plus a $1,000,000 death benefit only during the term. Whole life yields $436,800 cash value plus $1,000,000 death benefit while premiums were paid, and potential guarantees and loans.
...
1. Estimate potential estate liquidity gap if heirs must buy out business 100%: assume business valuation remains $5,000,000 and estate taxes or liquidity needs require 40% of value, gap = $2,000,000.
2. Consider purchasing a $2,000,000 whole life policy owned in an irrevocable life insurance trust. Policy proceeds are outside the probate estate and provide immediate cash.
3. Compute annual premium estimate for $2,000,000 whole life at age 45: illustrative premium $10,000 to $30,000 per year depending on underwriting and product. Assume $20,000 annual premium as an example.
4. Compare alternatives: selling a partial business stake, taking loans against business, or buying life insurance. Life insurance provides predictable cash with potential tax planning benefits if structured correctly.
...
- ✓
  ...
  Estimate coverage need using 10-12x annual income for income replacement; add specific debts such as a $300,000 mortgage directly.
- ✓

  IF dependents need income replacement for a finite period AND cost efficiency matters, THEN term life of 10-20 years may be more cost effective BECAUSE term provides far higher death benefit per premium dollar.
- ✓

  IF permanent liquidity for estate taxes or guaranteed lifetime coverage is required AND net worth or legal structure justifies it, THEN whole life or other permanent products may make sense BECAUSE they provide guaranteed death benefits and cash value that can be structured to pay taxes.
- ✓

  Compare total premiums and opportunity cost explicitly: investing the premium difference of $1,000-$1,500 per month at 5% can outperform a cash-value policy growing at 2-4% over 10-20 years.
- ✓

  Factor in insurability risk: if future health is uncertain, buying some permanent coverage early may protect against later uninsurability and provide value that pure term cannot replicate.

## Common Mistakes

- ✗

  Buying permanent coverage primarily as an investment without comparing expected returns. This is wrong because cash-value returns often net to 1-4% which compares poorly to expected equities at 5-7% after reasonable fees.
- ✗

  Using employer group life as the only coverage source without adjusting for job changes. This fails because group coverage often equals 1-3x salary and may vanish or be taxable, leaving a gap versus the 10-12x target.
- ✗

  Underinsuring because small savings or an emergency fund reduce perceived need. This misses income replacement math since $20,000 in savings does not replace a $100,000 income for 12 years.
- ✗

  Assuming whole life eliminates liquidity problems without modeling policy loan costs, surrender charges, and tax consequences. Policy loans reduce the death benefit and may create taxable events if the contract lapses.
