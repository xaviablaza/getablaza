...
> Source-copy draft imported from [https://templeton.host/visualizations/cross-entropy/](https://templeton.host/visualizations/cross-entropy/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
