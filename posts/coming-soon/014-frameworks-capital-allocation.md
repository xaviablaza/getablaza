...
> Source-copy draft imported from [https://templeton.host/frameworks/capital-allocation/](https://templeton.host/frameworks/capital-allocation/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
...
What AI did: shifted a large class of operating instruments from “not worth building” to “high Sharpe.” Tasks that had [T ~ 1](/lexicon/#templeton-ratio) (no leverage) suddenly have T >> 1 (massive leverage). The menu of viable investments expanded.
