...
> Source-copy draft imported from [https://templeton.host/tech-tree/relations/](https://templeton.host/tech-tree/relations/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
