...
> Source-copy draft imported from [https://templeton.host/tech-tree/convex-optimization/](https://templeton.host/tech-tree/convex-optimization/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
