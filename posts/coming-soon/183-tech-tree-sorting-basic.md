...
> Source-copy draft imported from [https://templeton.host/tech-tree/sorting-basic/](https://templeton.host/tech-tree/sorting-basic/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
