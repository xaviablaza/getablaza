...
> Source-copy draft imported from [https://templeton.host/visualizations/permutations/](https://templeton.host/visualizations/permutations/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
