...
> Source-copy draft imported from [https://templeton.host/tech-tree/utility-theory/](https://templeton.host/tech-tree/utility-theory/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
