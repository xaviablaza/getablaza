...
> Source-copy draft imported from [https://templeton.host/visualizations/greedy-algorithms/](https://templeton.host/visualizations/greedy-algorithms/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
