---
title: Debt Snowball
description: Pay smallest balance first, minimums on everything else. Behaviorally optimal - maximizes motivation through quick wins.
date: '2026-07-01'
...
source_format: html
inspiration_url: https://templeton.host/money/debt-snowball/
inspiration_category: money
---

> Source-copy draft imported from [https://templeton.host/money/debt-snowball/](https://templeton.host/money/debt-snowball/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
...
[Total Interest PaidBusiness

Direct behavioral counterpart - understanding total interest minimization requires contrasting it with the motivation-maximizing alternative to see the math-vs-psychology tradeoff](/business/total-interest-paid/)
...
1. Calculate total minimums: $15 + $30 + $60 + $150 = $255.
2. Extra available: $400 - 0 = $400 to direct after minimums. Under snowball, send all $400 extra to smallest balance A while paying each minimum.
3. Month 1 payment to A: $15 minimum + $400 extra = $415. Interest month 1 on A: $300 \* 0.18 / 12 = $4.50. Principal reduction approx $415 - $4.50 = $410.50. This pays off A fully in month 1, leaving $110.50 surplus to apply to next month.
4. Once A is paid, free $15 minimum + previously applied $400 = $415 per month now moves to B. New payment on B becomes $30 + $415 = $445 monthly. Interest month on B initially: $900 \* 0.16 / 12 = $12. Principal reduction roughly $433, so B clears in about 2 months.
5. After B clears, the rolled amount becomes $445 + $60 + $150 = $655 for C and D targets combined. Continue rolling until all balances clear. Total months to pay off estimate: A 1 month, B 3 months cumulative, C approx 6-12 months more, D remaining 18-30 months depending on exact amortization. Exact months computed by the n\text{n}n formula for each new payment size.
...
1. Compute minimums: $90 + $36 = $126. Extra available: $300.
2. Snowball ordering: Pay min on both, send $300 to smallest Y. Monthly to Y = $36 + $300 = $336. Interest on Y month 1: $1,200 \* 0.12 / 12 = $12. Principal approx $324, so Y clears in roughly 4 months. After Y clears, roll $336 + $36 = $372 into X making X payment $90 + $372 = $462 going forward.
3. Avalanche ordering: Pay min on both, send $300 to highest APR X. Monthly to X = $90 + $300 = $390. Interest on X month 1: $3,000 \* 0.22 / 12 = $55. Principal approx $335. X will take roughly 7-9 months longer than if given larger snowball-roll amounts initially.
4. Compute approximate total interest paid in both scenarios using amortization spreadsheets or the n\text{n}n formula. Avalanche usually saves interest; estimate shows avalanche may save about $200-$500 over total lifetime with these numbers, depending on exact months.
...
- ✓
  ...
  Use the monthly interest formula interest=balance×APR12\text{interest} = \text{balance} \times \frac{\text{APR}}{12}interest=balance×12APR​ to compute accrual, and the n\text{n}n months formula to compare payoff timelines.
- ✓
