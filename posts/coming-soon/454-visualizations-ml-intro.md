...
> Source-copy draft imported from [https://templeton.host/visualizations/ml-intro/](https://templeton.host/visualizations/ml-intro/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
