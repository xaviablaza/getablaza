...
> Source-copy draft imported from [https://templeton.host/visualizations/minimum-spanning-trees/](https://templeton.host/visualizations/minimum-spanning-trees/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
