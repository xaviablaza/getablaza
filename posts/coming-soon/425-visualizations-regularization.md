...
> Source-copy draft imported from [https://templeton.host/visualizations/regularization/](https://templeton.host/visualizations/regularization/). Names, domain references, and local media paths were adapted for Xavi Ablaza / getablaza.com.
